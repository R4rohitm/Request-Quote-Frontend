...
const Admin = () => {
    ...
    useEffect(()=>{
      ...
      const handle_fcl = ()=>{
         axios.get(`https://intoglo-first-api.herokuapp.com/quote/fetchbymode/FCL`)
         .then(({res})=>{
              setRq(res);
         }).catch((error) => {
            if(error.response)
         ...
         return (
                  ...
                  <aside class="w-64" aria-label="Sidebar">
                     <div class="overflow-y-auto py-4 px-3 bg-gray-50 rounded dark:bg-gray-800">
                        ...
                        <button type="button" onClick={handle_fcl} class="text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">FCL</button>
                        <button type="button" onClick={handle_air_sc} class="text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2">SC </button>
                         ...
                         <input type="text" name="email" placeholder='Enter email...' onChange={handleChange}/><br></br>
                        ...
                        {rq.length!=0 ? <Posts posts={currentPosts} /> : <> 
